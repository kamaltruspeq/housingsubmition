sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/Brunei/zhousingappsubmission/app", ".html");
		...
		return Opa5.extend("com.Brunei.zhousingappsubmission.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/Brunei/zhousingappsubmission/localService/mockserver"], function (mockserver) {
